(function () {
	...
	(function () {
		...
		waBtn.href = 'https://wa.me/923474195952?text=Hello%20I%20have%20a%20query%20regarding%20your%20services.';
		waBtn.target = '_blank';
		waBtn.rel = 'noopener noreferrer';
		waBtn.className = 'whatsapp-float';
		waBtn.setAttribute('data-tooltip', 'Contact via WhatsApp');
		waBtn.setAttribute('aria-label', 'Contact via WhatsApp');
		waBtn.innerHTML = '<svg fill="currentColor" viewBox="0 0 24 24"><path d="M12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21 5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.9-7.01A9.816 9.816 0 0012.04 2zm.01 1.75c2.18 0 4.23.85 5.77 2.39a8.066 8.066 0 012.39 5.77c0 4.5-3.66 8.16-8.17 8.16-1.47 0-2.9-.39-4.15-1.13l-.3-.18-3.06.8.82-2.99-.2-.31a8.154 8.154 0 01-1.12-4.15c0-4.51 3.65-8.16 8.16-8.16zm-3.86 4.9c-.24-.55-.42-.57-.77-.58-.2 0-.43 0-.66.01-.23.01-.55.09-.84.43-.29.34-1.1 1.07-1.1 2.61 0 1.54 1.12 3.03 1.28 3.24.16.21 2.17 3.38 5.25 4.68.73.31 1.3.5 1.75.64.73.23 1.4.2 1.92.12.59-.09 1.81-.74 2.07-1.45.25-.71.25-1.32.17-1.45-.08-.13-.29-.2-.61-.35-.31-.15-1.84-.91-2.12-1.01-.29-.1-.5-.15-.71.15-.21.29-.82 1.01-.99 1.21-.18.21-.36.23-.67.08-.31-.15-1.31-.48-2.49-1.53-.92-.82-1.54-1.83-1.72-2.14-.18-.31-.02-.48.13-.63.14-.14.31-.36.46-.54.15-.18.2-.31.3-.52.1-.21.05-.39-.02-.54-.08-.15-.71-1.71-.98-2.35z"/></svg>';
